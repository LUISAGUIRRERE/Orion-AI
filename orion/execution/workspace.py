...
RUNTIME_PATHS: tuple[str, ...] = (
    ...
    "workspace/runtime/",
    # BETA 008 (Project Intelligence): the Intelligence module's own
    # persisted index/graphs/reports (workspace/intelligence/), same
    # reasoning as every other entry above -- regenerated by analysis,
    # never part of any mission's own deliverable.
    "workspace/intelligence/",
    # BETA 009 (Business Brain): companies/projects/brand/goals/
    # roadmap/knowledge/memory/documents/decisions
    # (workspace/business_brain/) -- same reasoning, never part of any
    # mission's own deliverable. Found the hard way: forgetting this
    # entry (the exact same class of omission BETA 008 fixed for
    # workspace/intelligence/) left a real "dirty tree" failure the
